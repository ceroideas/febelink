            ...
            this.mailSvc.mailTo(
              {
                ...
                subject: this.api.translateSvc.instant(
                  'common.mailTo.block.title'
                ),

                msg:
                  this.api.translateSvc.instant('common.mailTo.from') +
                  bC +
                  from +
                  br +
                  br +
                  bO +
                  this.api.translateSvc.instant('common.mailTo.to') +
                  bC +
                  to +
                  br +
                  br +
                  bO +
                  this.api.translateSvc.instant('common.mailTo.msg') +
                  bC +
                  br +
                  data.report,
              },
