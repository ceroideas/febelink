...
export class SeoService {
  ...
  seoDEFAULT: SEOFebelink = {
        title: 'Febelink'
      , description: "El buscador de servicios profesionales"
  ...
  getTags() : SEOFebelink {
    ...
    let description: HTMLMetaElement | null = this.meta.getTag( "name=description" );
    ...
    return {
      ...
      , description : !description ? this.seoDEFAULT.description : description.content
