...
export class PublicarOpinionPage implements OnInit {
  ...
  public async ngOnInit() {
    ...
    (await this.api.getOpinionTypes()).subscribe( async res => {

      (await this.api.getSubSectores(this.navParams.get('id_demandante'))).subscribe( subsectores => {
  ...
  async submitForm() {
    ...
    (await this.api.publicarOpinion(type_id, subsector_id, this.id_demandante)).subscribe( resp => {
