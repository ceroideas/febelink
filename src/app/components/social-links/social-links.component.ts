...
export class SocialLinksComponent implements OnInit {
  ...
  private _telegram: string = 'https://t.me/joinchat/fnQ7Oqirk7pmMTlk'; 
  ...
  @Input() telegram: string;    @Input() show_telegram: boolean = false;
  @Input() twitter: string;     @Input() show_twitter: boolean = false;
  @Input() facebook: string;    @Input() show_facebook: boolean = false;
  ...
  private setVars() {
    this.telegram = this.nothingSet || this.show_telegram ? this._telegram : this.telegram;
    this.twitter = this.nothingSet || this.show_twitter ? this._twitter : this.twitter;
    this.facebook = this.nothingSet || this.show_facebook ? this._facebook : this.facebook;
    this.instagram = this.nothingSet || this.show_instagram ? this._instagram : this.instagram;
    this.youtube = this.nothingSet || this.show_youtube ? this._youtube : this.youtube;
    this.tiktok = this.nothingSet || this.show_tiktok ? this._tiktok : this.tiktok;
