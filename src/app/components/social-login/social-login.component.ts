...
export class SocialLoginComponent implements OnInit {
  ...
  public URL: string = 'social-login';
  ...
  */
  socialLogin( provider ): void {
    ...
    if(this.platform.is('cordova')){
      ...
      //Web
      this.authService.signIn( this.getProvider( provider) ).then(data => {
        ...
        this.utilities.showToast('Social Login error: '+JSON.stringify(err));
